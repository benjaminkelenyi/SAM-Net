...
from src.samnet.samnet import samnet
from src.samnet.utils.supervision import compute_supervision_coarse, compute_supervision_fine
...
class PL_samnet(pl.LightningModule):
    def __init__(self, config, pretrained_ckpt=None, profiler=None, dump_dir=None):
        ...
        # Matcher: LoFTR
        self.matcher = samnet(config=_config['aspan'])
